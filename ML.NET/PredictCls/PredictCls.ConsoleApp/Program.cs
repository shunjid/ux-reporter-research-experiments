...
namespace PredictCls.ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Using model to make single prediction -- Comparing actual ClsCategory with predicted ClsCategory from sample data...\n\n");
            ...
            Console.WriteLine($"\n\nPredicted ClsCategory value {predictionResult.Prediction} \nPredicted ClsCategory scores: [{String.Join(",", predictionResult.Score)}]\n\n");
